...
////////////////////////-----------------------------------39.90f
//////////////////////const fp32 Motor2_rang_PID_data[3] = {50.90f,0.0f,50.0f};//P,I,D值

const fp32 Motor2_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor2_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-3--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor3_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor3_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-4--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor4_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor4_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-5--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor5_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor5_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-6--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor6_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
//////////////////////////////////////65.90f,0.0f,70.0f---2023-6-25-20:00
const fp32 Motor6_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-7-------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor7_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor7_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-8--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor8_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor8_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值

//pid-9--------------------------------0.015f,0.0005f,0.03f-
const fp32 Motor9_speed_PID_data[3] = {0.01f,0.0006f,0.015f};//P,I,D值
//-----------------------------------39.90f
const fp32 Motor9_rang_PID_data[3] = {40.90f,0.0f,40.0f};//P,I,D值
//------------------------------------------------------------------------------
//pid-IMU-陀螺仪-X-方向---------------------------------------------------------
