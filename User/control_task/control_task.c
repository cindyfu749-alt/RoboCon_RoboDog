...
/** 目标关节角度 */
static float joint_angles[9] = {0};     // rang__2 至 rang__9
    ...
    switch (leg_idx) {
        case 0:  // 腿1
            if ((state->step == 2) || (state->step == 3)) {
                ...
                angle_out = &joint_angles[0];  // ran__2, ran__3
        ...
        case 1:  // 腿2
            if ((state->step == 4) || (state->step == 5)) {
                ...
                angle_out = &joint_angles[3];  // ran__5, ran__4
                counter_motion(foot->x, foot->y, angle_out, &angle_out[1]);
            }
            break;
        case 2:  // 腿3
            if ((state->step == 6) || (state->step == 7)) {
                ...
                angle_out = &joint_angles[4];  // ran__6, ran__7
                counter_motion(foot->x, foot->y, angle_out, &angle_out[1]);
            }
            break;
        case 3:  // 腿4
            if ((state->step == 8) || (state->step == 9)) {
                ...
                angle_out = &joint_angles[7];  // ran__9, ran__8
                counter_motion(foot->x, foot->y, angle_out, &angle_out[1]);
            }
            break;
    }
...
{
    if (!dog_state.print_flag) return;
