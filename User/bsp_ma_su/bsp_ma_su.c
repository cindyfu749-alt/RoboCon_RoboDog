...
float Motor_speed_PID_OUT[10];    ///< �ٶȻ� PID ��� (1-9)
float Motor_rang_PID_OUT[10];    ///< λ�û� PID ��� (1-9) 
...
/**
 * @brief ���λ��ƫ�Ʊ�����ʱ��ʼ��
 * @details �� main() �е���һ�Σ��� rang__* ����ӳ�䵽 motor_pos_offset[]
 */
void motor_pos_init(void)
{
	motor_pos_offset[0] = (Motor_Pos){0.0f, 0.0f};             // [0] δʹ��
	motor_pos_offset[1] = (Motor_Pos){0.0f, rang__2};          // [1] δʹ��
	motor_pos_offset[2] = (Motor_Pos){+11.184f, rang__2};      // [2] ���2
	motor_pos_offset[3] = (Motor_Pos){-9.080f, rang__3};       // [3] ���3
	motor_pos_offset[4] = (Motor_Pos){+0.501f, -rang__4};      // [4] ���4
	motor_pos_offset[5] = (Motor_Pos){-18.194f, -rang__5};     // [5] ���5
	motor_pos_offset[6] = (Motor_Pos){-12.201f, -rang__6};     // [6] ���6(Motor_Pos)
	motor_pos_offset[7] = (Motor_Pos){+4.448f, -rang__7};      // [7] ���7
	motor_pos_offset[8] = (Motor_Pos){-10.007f, rang__8};      // [8] ���8
	motor_pos_offset[9] = (Motor_Pos){+6.888f, rang__9};       // [9] ���9
}
